...
// Initialization code
	...
	self.valueTextField.text = [self.dateValue toFullDate];
}
...
- (BOOL)becomeFirstResponder {
	if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
		...
		[popoverController presentPopoverFromRect:self.valueTextField.frame inView:self permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
